                            ...
                            <>
                                ...
                                <div className="h-3/12 col-span-4 aspect-[4/3] sm:col-span-5 lg:col-span-6">
                                    ...
                                    <p className="mb-3 text-xl font-bold price text-brown">
                                        Rp
                                        {oneProduct.variants[0].price.toLocaleString(
                                            "id-ID"
                                        )}
                                    </p>
                                    ...
                                    <div className="mt-6 pd__variant">
                                        <p className="text-sm text-med-brown">
                                            Stok Tersedia:{" "}
                                            <span className="text-base font-bold">
                                                {
                                                    oneProduct.variants[0]
                                                        .quantity
                                                }{" "}
                                                buah
                                            </span>
                                    ...
                                    <Link
                                        ...
                                        className="flex items-center w-full gap-4 px-4 py-4 pt-3 mt-10 mb-10 rounded-lg HOVER-BRAND pd__brand bg-cream lg:w-3/4 xl:w-2/4"
                                    >
