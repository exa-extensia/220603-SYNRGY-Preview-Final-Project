...
// const SubBeautyFeed = ({ article, loading }) => {
//     if (loading) {
...
//                         <ul className="">
//                             <li key={data.id} className=" my-3 rounded-3xl shadow-xl hover:shadow-med-brown">
//                                 <img className="rounded-t-3xl" src={data.photo} />
//                                 <div className=" rounded-b-3xl h-[10%] cursor-pointer">
//                                     <h3 className="px-2 pt-2 truncate cursor-pointer">{data.title}</h3>
//                                     <p className="w-[95%] truncate  p-3 cursor-pointer">{data.content}</p>
//                                 </div>
//                             </li>
//                         </ul>
//                     </Link>
