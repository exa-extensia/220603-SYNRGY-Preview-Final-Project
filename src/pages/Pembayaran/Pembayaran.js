                        ...
                        <div className="cp__product__card__wrapper">
                                ...
                                <div className="cp__satubrand__input">
                                    <div className="cp__input">
                                        ...
                                        <div className="input__qty ">
                                            <p className="bg-slate-100 text-black px-3 rounded-full">2 barang</p>
                                        </div>
                                    ...
                                    <div className="cp__input">
                                        ...
                                        <div className="input__qty ">
                                            <p className="bg-slate-100 text-black px-3 rounded-full">1 barang</p>
                                        </div>
                                        <div className="input__price ">
                                            <p>Rp 150.000</p>
                                        </div>
                            ...
                            <div className="cp__card">
                                ...
                                <div className="flex">
                                    ...
                                    <div className="px-5">
                                        <p className="text-brown font-bold">Rumah - Angel (0812345678910)</p>
                                        <p>Perumahan Mendut Regency, Jalan Bandung 8 Blok I5, Kecamatan Bandung, Kota Bandung, Jawa Barat 16320</p>
                                    </div>
                                </div>
                                <div className="jasa-kurir flex mt-4 bg-blue-300 justify-evenly lg:justify-self-start">
                                    <div className="lg:mr-[50%]">
                                        <p className="font-bold">Pilih Jasa Kurir</p>
                                        <div className="bg-slate-200 rounded-full px-7">
                                            <Dropdown
                                                label="JNE"
                                                inline={true}
                                            >
                                    ...
                                    <div className="">
                                        ...
                                        <div className="bg-slate-200 rounded-full px-6">
                                            <Dropdown
                                                label="Reguler"
                                                inline={true}
                                            >
                            ...
                            <div className="cp__card__ringkasan">
                                <div className="mb-7">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <div className="w-2 h-2 bg-med-brown rounded-full"></div>
                                    </div>
                                </div>
                                ...
                                <button className="btn-sec w-full rounded-full py-2 font-bold uppercase text-slate-700 hover:text-white mt-2">
